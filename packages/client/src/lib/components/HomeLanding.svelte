...
<article class="bg-contain  md:bg-cover p-8 pt-40 w-full flex flex-col items-center h-landing bg-neutral-200 gap-20 sm:p-40">
    <section in:slide class="text-md md:text-xl p-10 text-slate-500 rounded-md flex items-center gap-2">
    ...
    {#if invalid}
    <p class="text-xl text-slate-500 bg-neutral-50 p-5 rounded-md">Please enter a valid ethereum address</p>
    {/if}
</article>
